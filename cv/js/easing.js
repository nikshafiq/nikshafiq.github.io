...
<head>
	...
	<link href="CV/css/bootstrap.css" rel='stylesheet' type='text/css' />
	<link href="CV/css/style.css" rel="stylesheet" type="text/css" media="all" />
	<link href='//fonts.googleapis.com/css?family=Lato:100,300,400,700,900' rel='stylesheet' type='text/css'>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
	<!---- start-smoth-scrolling---->
		<script type="text/javascript" src="CV/js/move-top.js"></script>
		<script type="text/javascript" src="CV/js/easing.js"></script>
	      ...
	      <div class="container">
		     <div class="banner-info">
			      <div class="bannerlogo">
					  <img src="CV/images/diamond.png">
			      </div>
			      <div class="bannerhead">
				      <h2>My name is <span>Sharq</span></h2>
			 ...
			 <div class="skills-grids">
				  <div class="skill-section text-center">
					  <h2><span> </span>SKILLS<span> </span></h2>
						...
						<!---->
						 <script type="text/javascript" src="CV/js/circles.js"></script>
									 <script>
										var colors = [
			  ...
			  <div class="container">
				  <div class="portfolio-grids">
					  <div class="portfolio-grid col-md-4">
						 <a href="#"><img src="CV/images/1.jpg"></a>
						  <p>Proin gravida nibh vel velit auctor aliquet.
							 Aenean sollicitudin, lorem quis bibendum</p>
						  <a class="rightarrow" href="#"><span> </span></a>
					  </div>
					  <div class="portfolio-grid col-md-4">
						  <a href="#"><img src="CV/images/2.jpg"></a>
						  <p>Proin gravida nibh vel velit auctor aliquet.
							 Aenean sollicitudin, lorem quis bibendum</p>
						  <a class="rightarrow" href="#"><span> </span></a>
					  </div>
					  <div class="portfolio-grid col-md-4">
						  <a href="#"><img src="CV/images/3.jpg"></a>
						  <p>Proin gravida nibh vel velit auctor aliquet.
							 Aenean sollicitudin, lorem quis bibendum</p>
						  <a class="rightarrow" href="#"><span> </span></a>
					  </div>
			 ...
			 <div class="col-md-6">
				  <div class="footer-left">
						<div class="social-icons">
						   <a href="#"><img src="CV/images/in.png"></a>
						   <a href="#"><img src="CV/images/twt.png"></a>
						   <a href="#"><img src="CV/images/fb.png"></a>
					   </div>
			  ...
			  <div class="col-md-6">
				 ...
				 <form>
				  ...
				  <div class="clear"></div>
				 <p class="copy-right"> &copy; 2014 Resume. All rights reserved | Template by <a href="http://w3layouts.com/">W3layouts</a></p>
			  </div>
		 </div>
	 </div>
